...
<body>
	<form action="applyStudentIDCard" method="post">
		...
		<input type="text" name="instituteName"><br>
		<label>Enter Course Name:</label>
		<input type="text" name="courseName"><br>
		<label>Enter Academic Year:</label>
		<input type="text" name="academicYear"><br>

		<input type="submit" value="Apply for Student ID Card" name="applyStudentIDCard">
	</form>
</body>
</html>